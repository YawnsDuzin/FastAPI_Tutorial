...
> **초보자 안내:** 이 문서는 **"API 사전"**처럼 사용하세요!
>
> ```
> [이 문서 사용법]
>
> 1. 필요한 기능 찾기 (예: 로그인하고 싶다 → POST /auth/login)
> 2. 요청 형식 확인 (어떤 데이터를 보내야 하는지)
> 3. 응답 형식 확인 (어떤 데이터를 받게 되는지)
> 4. 에러 코드 확인 (실패 시 어떤 코드가 오는지)
> ```
>
> **꿀팁:** 실제로 테스트하려면 `http://localhost:8000/docs`의 Swagger UI를 사용하세요!
